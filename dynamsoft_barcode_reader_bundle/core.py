...
class EnumErrorCode(IntEnum):
    ...
    EC_DBR_LICENSE_NOT_FOUND = _DynamsoftCore.EC_DBR_LICENSE_NOT_FOUND
    ...
    EC_DLR_LICENSE_NOT_FOUND = _DynamsoftCore.EC_DLR_LICENSE_NOT_FOUND
    EC_QUADRILATERAL_INVALID = _DynamsoftCore.EC_QUADRILATERAL_INVALID
    EC_DDN_LICENSE_NOT_FOUND = _DynamsoftCore.EC_DDN_LICENSE_NOT_FOUND
    ...
    EC_DCP_LICENSE_NOT_FOUND = _DynamsoftCore.EC_DCP_LICENSE_NOT_FOUND
